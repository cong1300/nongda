...
public class ResultQueryActivity extends AppCompatActivity {
    ...
    {
        attendanceRecord = (TextView) findViewById(R.id.teacher_query1);
        constitutionQuery = (TextView) findViewById(R.id.teacher_query2);
        onlineAnswer = (TextView) findViewById(R.id.teacher_query3);
        sportsPerformance = (TextView) findViewById(R.id.teacher_query4);
    }
    /**
     * 点击事件
     * 点击相应的TextView进行页面跳转
